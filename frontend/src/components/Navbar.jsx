...
const Navbar = ({ onOpenChat }) => {
  ...
  // Load saved profile from localStorage on mount (as a cache / fallback)
  useEffect(() => {
    try {
                  ...
                  <div className="px-6 pt-5 pb-4 border-b border-gray-800/80">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="text-white text-sm font-semibold">My Account</h3>
                          <p className="text-gray-500 text-xs mt-0.5">Manage your profile</p>
                        </div>
                      </div>
                      <button
