            ...
            <>
              ...
              >
                ...
                <div className="mt-8 pt-6 border-t border-gray-800 w-full flex flex-col items-center gap-4">
                  {user ? (
                    <>
                      <div className="flex items-center gap-3 bg-gray-800/50 border border-gray-700 w-full px-5 py-3 rounded-2xl">
                        <div className="w-10 h-10 rounded-full bg-emerald-500/20 border border-emerald-500 text-emerald-400 font-bold flex items-center justify-center text-lg shrink-0">
                          {user.email.charAt(0).toUpperCase()}
                        </div>
                      ...
                      <motion.button
                        ...
                        className="w-full border border-red-500/50 text-red-400 hover:bg-red-500/10 px-6 py-3 rounded-xl font-medium transition-colors text-base flex items-center justify-center gap-2"
                      >
                    ...
                    <motion.button
                      ...
                      className="w-full border border-emerald-500 text-emerald-400 hover:bg-emerald-500/10 px-6 py-3 rounded-xl font-medium transition-colors text-base"
                    >
                      Log In
                    </motion.button>
                  )}
