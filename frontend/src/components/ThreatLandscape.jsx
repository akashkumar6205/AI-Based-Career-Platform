  ...
  return (
    <section id="threat" className="py-24 bg-gray-900 overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        >
          <div className="text-emerald-500 font-semibold uppercase tracking-wider mb-2 text-sm">The Threat Landscape</div>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">The Job Market Is a <span className="gradient-text">Minefield.</span></h2>
