  ...
  return (
    <section id="hero" className="relative min-h-[calc(100vh-160px)] flex items-center justify-center pb-12 overflow-hidden" ref={containerRef}>
      ...
      <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
        ...
        >
          🛡️ Trusted by 10,000+ Students Nationwide
        </motion.div>
        ...
        >
          CareerShield AI is your all-in-one career companion — it detects fake job postings & phishing emails, optimizes your resume for ATS bots, and coaches you through mock interviews. All powered by AI. All free to start.
        </motion.p>
      </div>
