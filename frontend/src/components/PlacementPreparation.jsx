  ...
  return (
    <section className="pt-32 pb-24 bg-gray-950 min-h-[80vh] flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="text-emerald-500 font-semibold uppercase tracking-wider mb-2 text-sm">Placement Preparation</div>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">Level Up Your <span className="gradient-text">Interview Skills.</span></h2>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-400 leading-relaxed">
            We are building an interactive placement preparation module with targeted guidance on technical interviews, aptitude tests, and domain-specific skills. 
            <br /><br />
